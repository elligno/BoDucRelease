...
namespace bdAPI {
  ...
  BoDucCmdFileReader::vecmapstr BoDucCmdFileReader::readFiles( const std::list<std::string>& aFilesNameWithPath,
...
//     if (!w_mapintVec.empty())
//     {
//       // clear all content
//       w_mapintVec.clear();
// 
//       // sanity check (write it to log file)
//       if (w_mapintVec.size() != 0)
//       {
